# mqtt broker where mbmd publishes its topics
...
mqtt_topics = {
    ...
    "mbmd/orno3p1-1/Current/L1": {
        "name": "mbmd_current",
        "help": "current in Ampere",
        "labels": {"phase": "L1"},
    },
    "mbmd/orno3p1-1/Current/L2": {
        "name": "mbmd_current",
        "help": "current in Ampere",
        "labels": {"phase": "L2"},
    },
    "mbmd/orno3p1-1/Current/L3": {
        "name": "mbmd_current",
        "help": "current in Ampere",
        "labels": {"phase": "L3"},
    },
    "mbmd/orno3p1-1/Voltage/L1": {
        "name": "mbmd_voltage",
        "help": "voltage in Volt",
        "labels": {"phase": "L1"},
    },
    "mbmd/orno3p1-1/Voltage/L2": {
        "name": "mbmd_voltage",
        "help": "voltage in Volt",
        "labels": {"phase": "L2"},
    },
    "mbmd/orno3p1-1/Voltage/L3": {
        "name": "mbmd_voltage",
        "help": "voltage in Volt",
        "labels": {"phase": "L3"},
    },
